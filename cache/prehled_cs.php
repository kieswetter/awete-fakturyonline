<div class="header">
       ...
       <div class="clear"></div>
       <a href="index.html"><img class="logo" src="<?php print getImgUrl("main_logo.gif");?>" alt="Návrat na úvodní stránku" /></a>
       <div class="clear"></div>
       <div class="zalozky">
          <?php if($main->zalozky) : ?> 
			<?php foreach($main->zalozky as $link) : ?>
       			<a href="<?php print $link->href;?>" <?php if($link->active):?>class="active"<?php endif;?>><?php print $link->text;?></a>
       		<?php endforeach; ?>
       		<div class="clear"></div>
       	<?php endif; ?>
          <a href="<?php print getUrl();?>" class="active">Faktura</a>
          <a href="prehled.html">Přehled faktur</a>
          <a href="zakazky.html">Zakázky</a>
          <div class="clear"></div>
       </div>
</div>
<div class="obsah">
	<div class="right_column">
        <h2>Uživatelský panel</h2>          
          <a class="nastaveni" href="nastaveni.html">Nastavení</a>
          <div class="clear"></div>
          <div class="panel">
            <div class="login">
              <p>Přihlášen: <strong>Franta Novák</strong><br />
